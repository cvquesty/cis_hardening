...
describe file('/etc/sysconfig/iptables') do
    ...
    its (:content) { is_expected.to match (/# This File Managed by Puppet. DO NOT EDIT./) }
    its (:content) { is_expected.to match (/-A INPUT -p tcp --dport 22 -m state --state NEW -j ACCEPT/) }
end
