...
class cis_hardening::auth::pam {
  ...
  # Ensure lockout delay for failed password attempts is configured - Section 5.4.2
  ...
  # Ensure Password Hashing Algorithm is SHA-512 - Section 5.4.3
  ...
  # Ensure Password Reuse is Limited - Section 5.4.4
