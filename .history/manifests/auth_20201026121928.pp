...
class cis_hardening::auth {
  ...
  include cis_hardening::auth::accounts   # Section 5.4 - User Accounts and Environment
  include cis_hardening::auth::su         # Section 5.5/5.6 - Root Account & su configuration
