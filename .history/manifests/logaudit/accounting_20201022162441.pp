...
class cis_hardening::logaudit::accounting {
  ...
  # Ensure audit logs are not automatically deleted - Section 4.1.2.2
  ...
  # Ensure discretionary access control permission modification events are collected - Section 4.1.
