...
class cis_hardening::auth::ssh {
  ...
  # Ensre only strong MAC algorithms are used - Section 4.2.14
  file_line { 'set_ssh_macs':
    ensure => 'present',
    path   => '/etc/ssh/sshd_config',
    line   => 'MACs hmac-sha2-512-etm@openssh.com,hmac-sha2-256-etm@openssh.com,hmac-sha2-512,hmac-sha2-2'
  }
