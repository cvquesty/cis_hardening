...
class cis_hardening::auth::ssh {
  ...
  #
  # NOTE: To use this feature, you must specify the users you wish to connect to the system
  # via SSH. The below stanza will allow you to do this by replacing the "<userlist>" item
