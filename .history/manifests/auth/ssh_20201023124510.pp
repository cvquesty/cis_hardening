...
class cis_hardening::auth::ssh {
  ...
  #
  # NOTE: To use this feature, you must specify the users or groups you wish to allow or deny connect to the system
  # via SSH. The below stanzas will allow you to do this by replacing the "<userlist>" item
  # with a list of space-seaprated usernames
  #
