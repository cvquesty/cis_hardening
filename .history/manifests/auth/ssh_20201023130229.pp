...
class cis_hardening::auth::ssh {
  ...
  file_line { 'ssh_keyexchange_algos':
    ...
    path   => '/etc/ssh/sshd_config',
    line   => 'KeyxAlgorithms curve25519-sha256,curve25519-sha256@libssh.org,diffie-helman-group14-sha256,diffie-helman-group16-sha512,diffie-hellman-group18-sha',
