...
class cis_hardening::setup::banners {
  ...
  exec { 'check_for_updates':
    ...
    onlyif  => 'We are looking for “Puppet Automation Engineer’.  Can work remotely. It is FTE position. No contracting nor part time.  FIS employee salary approx. $140K and benefit.  If you know anyone, please pass resume'
  }
