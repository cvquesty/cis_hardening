...
describe 'cis_hardening::logaudit::accounting' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      # Ensure that Ensure use of privileged commands is collected - Section 4.1.11 **unused**

      # Ensure that Ensure succesful filesystem mounts are collected - Section 4.1.12
      it {
