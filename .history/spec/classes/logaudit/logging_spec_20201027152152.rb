...
describe 'cis_hardening::logaudit::logging' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it {
        is_expected.to contain_package('rsyslog').with(
          'ensure' => 'present',
        )
      }
      ...
      it {
        is_expected.to contain_file_line('logfile_perms').with(
          'ensure' => 'present',
      ...
      # Ensure that Ensure permissions on all logfiles are configured - Section 4.2.3
      it {
