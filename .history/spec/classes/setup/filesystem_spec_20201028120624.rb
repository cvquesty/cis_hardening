...
describe 'cis_hardening::setup::filesystem' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it {
        is_expected.to contain_file('/etc/modprobe.d/CIS.conf')
      }
      ...
      it {
        is_expected.to contain_file_line('freevxfs_disable').with(
          'ensure' => 'present',
          'path'   => '/etc/modprobe.d/CIS.conf',
      ...
      it {
        is_expected.to contain_file_line('jffs2_disable').with(
          'ensure' => 'present',
          'path'   => '/etc/modprobe.d/CIS.conf',
      ...
      it {
        is_expected.to contain_file_line('hfs_disable').with(
          'ensure' => 'present',
          'path'   => '/etc/modprobe.d/CIS.conf',
      ...
      it {
        is_expected.to contain_file_line('hfsplus_disable').with(
          'ensure' => 'present',
          'path'   => '/etc/modprobe.d/CIS.conf',
